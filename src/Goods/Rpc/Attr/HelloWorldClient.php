...
class HelloWorldClient implements \Goods\Rpc\Attr\HelloWorldIf {
  ...
  {
    $args = new \Goods\Rpc\Attr\HelloWorld_sayHello_args();
    $args->name = $name;
  ...
  public function recv_sayHello()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Goods\Rpc\Attr\HelloWorld_sayHello_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Goods\Rpc\Attr\HelloWorld_sayHello_result();
